                            ...
                            <div className='bg-white shadow-md rounded px-7 pt-4 pb-6'>
                                <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
                                    ...
                                    <form onSubmit={handleSubmit(async (data) => {
                                        ...
                                        try {
                                            const res = await axios.post(`http://localhost:8080/api/v1/stream`, data);
                                            const addStreamToUniversity = await axios.post(`http://localhost:8080/api/v1/addStream/${params.id}/${res.data.id}`)
                                            console.log(res.data, "data");
                                            console.log(addStreamToUniversity.data, "addStreamToUniversity");

                                            toast.success("Stream added successsfully", {});
                                            navigate(`/addCourse/${res.data.id}`)
